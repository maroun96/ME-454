...
subject to cop_hp {t in Time}:
	(Theating['HighT']+273.15-T_source_HP)*COP_LP[t]=carnot_LP[t]*(Theating['HighT']+273.15);
	
	
/*---------------------------------------------------------------------------------------------------------------------------------------
Set flow rate of Electriciy as a function of the COP
---------------------------------------------------------------------------------------------------------------------------------------*/
let Qheatingsupply['HP2stage'] := 5000; 
var Wcompressor_HP2stage{Time} >=0.001;
subject to W_comp {t in Time}:										
	 Wcompressor_HP2stage[t] = Qheatingsupply['HP2stage']/COP_LP[t]+Qheatingsupply['HP2stage']/COP_LP[t];		#Power of one compressor of the two stage HP
