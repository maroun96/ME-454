...
param I_2010 default 550.8;										#Cost Index 2010
param I_2009 default 550.8;										#Cost Index 2009
...
param QAir{u in {"Air"}, t in Time} default 0;
...
param Flowin_Air{l in Layers, u in {"Air"}, t in Time} default 0;
...
subject to MT_balance{t in Time}:
	Qheatingdemand['MediumT',t] = sum{u in UtilitiesOfType['Heating']: Tminheating[u] >= Theating['MediumT'] + dTmin} (Qheatingsupply[u] * mult_heating_t[u,t,'MediumT']) + QAir["Air",t]*mult_t["Air",t] + QAirHP["AirHP",t]*mult_t["AirHP",t]+ QHPDatacenter["HPDatacenter",t]*mult_t["HPDatacenter",t];
...
---------------------------------------------------------------------------------------------------------------------------------------*/
subject to inflow_cstr {l in Layers, u in UtilitiesOfLayer[l] diff {"HP1stageLT", "HP1stageMT","Air","AirHP","HPDatacenter", "HP2stage"}, t in Time}:
...
subject to inflow_cstr6 {l in Layers, u in {"Air"}, t in Time}:
	FlowInUnit[l,u,t] = mult_t[u,t] * Flowin_Air[l,u,t];
